...
- passo 1 - pegar no JS o elemento HTML correspondente ao botao de troca detema
- passo 2 - darum jeito de pegar no JS o elemento HTML corresponde ao body
- passo 3 - dar um jeito de identificaro clique do usuário no botão de troca de tema
...
- passo 8 - trocar a imagem do botão de alterar tme pra sol
*/
...
const imagem = imagemBotaoTrocaDeTema = document.querySelector(".imagem-botao");
